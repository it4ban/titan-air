  ...
  >
    <div class="category-block__wrapper">
      ...
      <div class="category-text">
        <div class="category-text__header">
          <slot name="header" />
        </div>
        <div class="category-text__description">
...
.category-block {
  background: linear-gradient(152.51deg, #213249 32.89%, #172638 67.11%);
