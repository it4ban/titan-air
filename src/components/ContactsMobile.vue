<template>
  <button class="contacts-switcher" @click="toggleSidebarContacts">
  ...
  <div :class="['contacts-mobile', { 'contacts-mobile--open': isOpen }]">
    <div class="contacts-mobile__content">
      <button class="contacts-mobile__close" @click="toggleSidebarContacts">
        <svg
          width="31"
          height="31"
          viewBox="0 0 31 31"
      ...
      <div class="contact-item">
        <span class="contrast-header contact-item__header">ADDRESS:</span>
      ...
      <div class="contact-item">
        <span class="contrast-header contact-item__header">TELEPHONE:</span>

        <div class="contact-item__content">
          <a href="tel:420999999999" class="contact-item__info"> +420 9999 - 99 - 999; </a>
          <a href="tel:420999999999" class="contact-item__info"> +420 9999 - 99 - 999 </a>
        </div>
      </div>

      <div class="contact-item">
        <span class="contrast-header contact-item__header">FAX:</span>
      ...
      <div class="contact-item">
        <span class="contrast-header contact-item__header">E-MAIL:</span>

        <div class="contact-item__content">
          <a
            href="mail:titan.airservice@mail.com"
            class="contact-item__info contact-item__info--email"
            >titan.airservice@mail.com</a
          >
        </div>
      </div>

      <div class="sidebar-right__socials">
        <span class="contrast-header contact-item__header">SOCIAL NETWORKS:</span>

        <div class="sidebar-right__socials-icons">
